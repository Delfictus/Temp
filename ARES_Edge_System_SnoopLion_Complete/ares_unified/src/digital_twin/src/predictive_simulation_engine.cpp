    ...
    for (uint32_t i = 0; i < num_scenarios; ++i) {
        ...
        switch (type) {
            case ScenarioType::NOMINAL:
                scenario.description = "Nominal conditions";
                break;
                
            case ScenarioType::FAILURE_MODE:
                scenario.description = "Component failure scenario " + std::to_string(i);
            ...
            case ScenarioType::ADVERSARIAL:
                scenario.description = "Adversarial scenario " + std::to_string(i);
            ...
            case ScenarioType::ENVIRONMENTAL:
                scenario.description = "Environmental variation " + std::to_string(i);
